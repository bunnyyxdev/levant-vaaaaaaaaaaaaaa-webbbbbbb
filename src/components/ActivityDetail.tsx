                ...
                <div className="md:col-span-2 glass-card p-6">
                    <div className="flex items-center gap-3 mb-4">
                        ...
                        {activity.status?.ribbonText && (
                            <span className="flex items-center gap-2 text-xs bg-dark-700 px-3 py-1 rounded">
                            ...
                            {interests.length > 0 ? (
                                interests.map((interest: any) => (
                                    <div key={interest._id} className="flex items-center gap-3">
                                        <div className="w-8 h-8 bg-dark-700 rounded-full flex items-center justify-center text-gray-400">
                                    ...
                                    <tr key={entry._id} className="border-b border-white/5">
                                        <td className="py-3">
                                            {entry.pilot?.profileImage ? (
                                                ...
                                                <div className="w-8 h-8 bg-dark-700 rounded-full flex items-center justify-center text-gray-500">
                                                    <Users className="w-4 h-4" />
                                                </div>
                                            )}
                                        </td>
