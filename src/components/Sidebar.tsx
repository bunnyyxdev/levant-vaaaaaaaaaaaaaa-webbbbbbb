    ...
    return (
        <aside className="w-64 bg-dark-900 border-r border-white/5 flex-shrink-0 flex flex-col h-screen fixed top-0 left-0 pt-4 overflow-y-auto">
            ...
            <div className="p-4 border-t border-white/5">
                <Link href="/api/auth/logout" className="flex items-center px-2 py-3 text-sm font-medium text-gray-400 hover:text-red-400 hover:bg-red-500/10 rounded-lg transition-colors">
