                ...
                <div className="space-y-6">
                    <section>
                        ...
                        <ul className="grid gap-2">
                            {[
                                'Pilots must maintain a professional conduct on IVAO/VATSIM.',
                    ...
                    <section>
                        ...
                        <div className="grid grid-cols-2 gap-4">
                            <div className="p-3 bg-green-500/10 border border-green-500/20 rounded-lg">
                                ...
                                <p className="text-[10px] text-gray-500">Full points awarded</p>
                            </div>
                            <div className="p-3 bg-yellow-500/10 border border-yellow-500/20 rounded-lg">
                                ...
                                <p className="text-[10px] text-gray-500">Partial points awarded</p>
                            </div>
                        </div>
                    </section>
                </div>
        ...
        },
        {
            ...
            content: (
                <div className="space-y-4">
                    ...
                    <div className="bg-dark-700/50 rounded-xl border border-white/5 divide-y divide-white/5">
        ...
        },
        {
            ...
            content: (
                <div className="space-y-4">
                    ...
                    <div className="p-4 bg-dark-700/50 rounded-xl border-l-4 border-accent-gold">
                    ...
                    <div className="flex gap-3 p-4 bg-red-500/10 border border-red-500/20 rounded-xl">
                        ...
                        <p className="text-xs text-gray-400">
                            Failing to communicate on networks like IVAO or VATSIM can lead to suspension from the VA.
                        </p>
                    </div>
                </div>
            )
        ...
        <div className="space-y-6">
            <div className="glass-card p-6">
                <div className="flex items-center gap-3">
                    <Book className="w-8 h-8 text-accent-gold" />
                    <div>
                        <h1 className="text-2xl font-bold text-white">Pilot Handbook</h1>
                        <p className="text-gray-400">Rules, regulations, and guidelines</p>
                    </div>
                </div>
            </div>
                        ...
                        <button
                            ...
                            className={`w-full flex items-center justify-between p-4 rounded-xl border transition-all ${
                                activeSection === section.id
                                    ...
                                    : 'bg-dark-700/50 border-white/5 text-gray-400 hover:text-white hover:bg-white/5'
                            }`}
                        >
                            <div className="flex items-center gap-3">
