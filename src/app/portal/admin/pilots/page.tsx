...
export default function AdminPilotsPage() {
    ...
    const getStatusIcon = (status: string) => {
        switch (status) {
            ...
            case 'Blacklisted': return <ShieldAlert className="w-4 h-4 text-red-600 font-bold" />;
            default: return null;
        }
    };
        ...
        <div className="space-y-6">
            ...
            <div className="grid md:grid-cols-3 gap-4">
                <div className="relative md:col-span-2">
                    ...
                    <input
                        ...
                        className="w-full bg-dark-800 border border-white/10 rounded-lg pl-12 pr-4 py-3 text-white focus:outline-none focus:border-accent-gold"
                    />
                </div>
                <div className="relative">
                    ...
                    <select
                        ...
                        className="w-full bg-dark-800 border border-white/10 rounded-lg pl-12 pr-4 py-3 text-white focus:outline-none focus:border-accent-gold appearance-none"
                    >
            ...
            {editing && (
                <div className="fixed inset-0 bg-black/80 flex items-center justify-center z-50 p-4">
                    <div className="bg-dark-800 rounded-xl w-full max-w-md border border-white/10 shadow-2xl overflow-hidden">
                        ...
                        <div className="p-6 space-y-4">
                            ...
                            <div>
                                ...
                                <div className="grid grid-cols-2 gap-2">
                                    {['Active', 'Pending', 'Inactive', 'Blacklisted'].map((s) => (
                                        <button
                                            key={s}
                                            ...
                                            className={`py-2 px-3 rounded border text-xs font-semibold transition-all ${
                                                editing.status === s 
                                                    ...
                                                    : 'bg-dark-700 border-white/5 text-gray-400 hover:border-white/20'
                                            }`}
                                        >
                                            {s}
                                        </button>
                        ...
                        <div className="p-6 bg-dark-900/50 border-t border-white/5 flex justify-end">
                            <button
